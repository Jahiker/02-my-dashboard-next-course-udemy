        ...
        <a href="#" className="inline-flex space-x-2 items-center">
          <span>
            <Image
              ...
              src="https://jahiker.github.io/jahiker/assets/avatar-1f0bf45f.jpeg"
              alt="Avatar Image"
              width={100}
              height={100}
            />
          </span>
          <span className="text-sm md:text-base font-bold">Jahiker Rojas</span>
        </a>
      </div>
